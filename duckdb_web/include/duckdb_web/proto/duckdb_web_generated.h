...
#ifndef FLATBUFFERS_GENERATED_DUCKDBWEB_DUCKDB_WEB_PROTO_H_
#define FLATBUFFERS_GENERATED_DUCKDBWEB_DUCKDB_WEB_PROTO_H_
...
inline flatbuffers::Offset<DuckDBColumn> CreateDuckDBColumnDirect(
  ...
  return duckdb_web::proto::CreateDuckDBColumn(
      _fbb,
      data__,
      nullmask__,
      type,
...
inline flatbuffers::Offset<DuckDBResult> CreateDuckDBResultDirect(
  ...
  return duckdb_web::proto::CreateDuckDBResult(
      _fbb,
      columns__,
      rows,
      error_message__);
...
#endif  // FLATBUFFERS_GENERATED_DUCKDBWEB_DUCKDB_WEB_PROTO_H_
