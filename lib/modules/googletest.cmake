...
ExternalProject_Add(
    gtest_ep
    PREFIX "${CMAKE_BINARY_DIR}/modules/gtest"
    SOURCE_DIR "${CMAKE_SOURCE_DIR}/modules/googletest/googletest"
    CMAKE_ARGS
        -G${CMAKE_GENERATOR}
...
ExternalProject_Add(
    gmock_ep
    PREFIX "${CMAKE_BINARY_DIR}/modules/gmock"
    SOURCE_DIR "${CMAKE_SOURCE_DIR}/modules/googletest/googlemock"
    CMAKE_ARGS
        -G${CMAKE_GENERATOR}
        -DCMAKE_CXX_STANDARD=17
        -DCMAKE_CXX_FLAGS=-std=c++17
